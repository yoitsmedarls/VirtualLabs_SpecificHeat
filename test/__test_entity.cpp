...
int main()
{
    ...
    std::shared_ptr<vl::Entity> myEntity = vl::EntityManager::Instance().createEntity("My Entity 1");
    myEntity->addSprite2DComponent("Background", "../assets/images/background.png");
    ...
    while (window.isOpen())
    {
        ...
        vl::EntityManager::Instance().RenderEntities(window);
